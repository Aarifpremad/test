...
const notificationlist = async (req, res) => {
    try {
        ...
        const notifications = await Model.UserNotification.find({ user: userId }).sort({ createdAt: -1 });
...
module.exports = { signUp, signIn, sendOtp ,verifyOtp ,getProfile ,deleteAccount , uploadProfileImage,updateProfile ,createEnquiry, getEnquiries, deleteEnquiry , userlist , notificationlist};